...
export const createBusiness = createAsyncThunk('business/create',async (business:Business):Promise<ReturnResponse> => {
    try {
...
export const getBusiness = createAsyncThunk('business/getBusiness', async(businessId: string):Promise<ReturnResponse> => {
    try {
